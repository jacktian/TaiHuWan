...
public class PostInfo extends BaseData {
	...
	public static PostInfo getPostInfoFromElement(Element url) {
		...
		// Element website =
		// (Element)display.getElementsByTagName("website").item(0);
		// Element siteurl =
		// (Element)display.getElementsByTagName("siteurl").item(0);
		...
		// Element signid =
		// (Element)display.getElementsByTagName("signid").item(0);
		...
		// Element rebate =
		// (Element)display.getElementsByTagName("rebate").item(0);
		...
		postInfo.getPostBasic().setContent(
				"原价:" + value.getFirstChild().getNodeValue() + "     现价:" + price.getFirstChild().getNodeValue());
