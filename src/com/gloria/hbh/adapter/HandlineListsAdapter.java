...
public class HandlineListsAdapter extends Adapter_Base
{
    ...
    public View getView(int position,View convertView,ViewGroup parent)
    {
        ...
        {
            item.item_title.setText(Html.fromHtml("<b><font color=#999999>"+handlinesBasicInfos.get(position).getTitle()+"</font></b>"));
        }
        ...
        if(handlinesBasicInfos.get(position)!=null&&handlinesBasicInfos.get(position).getImg()!=null&&!handlinesBasicInfos.get(position).getImg().equals(""))
        {
            //			String img_url = BaseConfig.requestImageUrl(ScreenUtils.getInstance().getWidth()/4, ScreenUtils.getInstance().getWidth()*3/(4*4), 
            //					handlinesBasicInfos.get(position).getImg(), ImgScaleTypeConstants.IMGTYPE_INYERCEPT);
