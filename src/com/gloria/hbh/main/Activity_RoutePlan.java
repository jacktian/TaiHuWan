...
//		stNode.name = editSt.getText().toString();
		...
		if (titlebar_drive.equals(v)) {
			mSearch.drivingSearch("我的位置", stNode, "太湖湾嬉戏谷", enNode);
		} else if (titlebar_bus.equals(v)) {
			mSearch.transitSearch("我的位置", stNode, enNode);
		} else if (titlebar_walk.equals(v)) {
			mSearch.walkingSearch("我的位置", stNode, "太湖湾嬉戏谷", enNode);
		} 
	}
