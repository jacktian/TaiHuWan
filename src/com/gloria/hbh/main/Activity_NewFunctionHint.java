...
//				if(arg2 == BaseConfig.newFunctionHintPics.length-1 && !type.equals("FromSystemSet")){
...
//		});
		...
		galleryimg.setAdapter(new BaseAdapter(){
			public View getView(int position, View convertView, ViewGroup parent){
				...
				if (convertView == null)
				{
					convertView = LayoutInflater.from(Activity_NewFunctionHint.this).inflate(R.layout.gallery_row_img_layout, null);
					view = new ViewClass();  
