...
public class BaseConstants {
	...
	public static String Save_RootFile = BaseApplication.getInstance()
			.getString(R.string.app_name);   //应用的存放的文件夹
	...
	public static final String SharedPreferences_LoginInfo= "LoginInfo";  //登录的用户名，密码等帐号列表的 key索引 
	public static final String SharedPreferences_WeiBoShareInfo = "WeiBoShareInfo";  //分享的 key索引 
	...
	public static String CACHE_SAVE_IMG_PATH = Environment.getExternalStorageDirectory() + File.separator+Save_RootFile+File.separator+"Imgs/";  //保存相册的路径
